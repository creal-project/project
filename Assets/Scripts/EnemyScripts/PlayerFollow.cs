...
public class PlayerFollow : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if(GameManager.Instance.currentPlayerRoom == currentEnemyRoom){
            ...
            if(playerDistence <= GameManager.Instance.enemyDetectDistence && player.GetComponent<Player>().hp>0){
            ...
            if(playerDistence <= GameManager.Instance.enemyAttackDistence && player.GetComponent<Player>().hp>0){
